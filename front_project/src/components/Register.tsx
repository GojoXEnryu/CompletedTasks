...
function Register() {
    ...
    return (
        <div id="Register">
            ...
            <button id="RegistrationButton" onClick={registerUser}
                    style = {{width: "200px", height:"50px",
            ...
            <input type="string" id="FirstNameInput" onChange={handleFirstName}
            ...
            <input type="string" id="LastNameInput" onChange={handleLastName}
                   style = {{width: "325px", height:"25px",
            ...
            <input type="string" id="EmailInput" onChange={handleEmail}
                   style = {{width: "325px", height:"25px",
